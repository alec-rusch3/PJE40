...
public class BarnesHutParallel1 extends Thread {
...
//       double nx = 0, ny = 0, nz = 1.0;
        ...
        BarnesHutParallel1[] threads = new BarnesHutParallel1[P];
        for (int me = 0; me < P; me++) {
            threads[me] = new BarnesHutParallel1(me);
            threads[me].start();
        }
