...
public class BarnesHutParallel extends Thread {
...
//       double nx = 0, ny = 0, nz = 1.0;
        ...
        BarnesHutParallel[] threads = new BarnesHutParallel[P];
        for (int me = 0; me < P; me++) {
            threads[me] = new BarnesHutParallel(me);
            threads[me].start();
        }
